...
if(strlen($_SESSION['login'])==0)//no email login 
  { 
...
$sql="INSERT INTO  tbltestimonial(UserEmail,Testimonial) VALUES(:email,:testimonoial)";//update table with new values
$query = $dbh->prepare($sql);// tells the database what the parameters are.
$query->bindParam(':testimonoial',$testimonoial,PDO::PARAM_STR);//string
...
if($lastInsertId)
{
$msg="Отзыв успешно отправлен";//success message
}
else 
{
...
<title>Ashley |Оставить Отзыв</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Оставьте отзыв</h5>
