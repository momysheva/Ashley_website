...
$msg="Рекомендация успешно инактивированна";
}
...
$msg="Рекомендация успешно активирована";
}
...
<head>
	...
	<title>Портал |Админ Рекомендации   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Управлять Рекомендациями </h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Рекомендация Пользователя</div>
...
{
	?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Хотите активировать?')"> Inactive</a>
<?php } else {?>

<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Хотите инактивировать?')"> Active</a>
</td>
<?php } ?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
