...
<head>
	...
	<title>Портал | Админ Добавить Товар</title>
...
<label class="col-sm-2 control-label">Выбрать группу<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<option value="Второстепнный">Второстепенный</option>
<option value="Декоротивный">Декоротивный</option>
</select>
</div>
</div>
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Действует</div>
<div class="panel-body">
...
<label for="othercolors">Другие цвета </label>
</div>
</div>
...
<input type="checkbox" id="ustanovka" name="ustanovka" value="1">
<label for="inlineCheckbox5">Установка </label>
</div>
</div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="dopolnenie" name="dopolnenie" value="1">
<label for="dopolnenie">Дополнение</label>
</div>
</div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="odin">Один экземпляр </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="production" name="production" value="1">
<label for="production">Другое производство </label>
</div>
</div>
</div>
